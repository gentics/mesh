...
public interface AUser extends AMeshCoreElement<UserResponse>, AUserTrackingVertex {
	 ...
	 * @return Fluent API
	 */
	AUser setUsername(String string);
	 ...
	 * @return Fluent API
	 */
	AUser setEmailAddress(String email);
	 ...
	 * @return Fluent API
	 */
	AUser setLastname(String lastname);
	 ...
	 * @return Fluent API
	 */
	AUser setFirstname(String firstname);
	...
	// blocking
	AUser setPasswordHash(String hash);
	 ...
	 * @return Fluent API
	 */
	AUser setPassword(String password);
	 ...
	 * @return Fluent API
	 */
	AUser setReferencedNode(Node node);
	 ...
	 * @return Fluent API
	 */
	AUser addCRUDPermissionOnRole(HasPermissions sourceNode, GraphPermission permission, MeshVertex targetNode);
	 ...
	 * @return Fluent API
	 */
	AUser addPermissionsOnRole(HasPermissions sourceNode, GraphPermission permission, MeshVertex targetNode, GraphPermission... toGrant);
	 ...
	 * @return Fluent API
	 */
	AUser inheritRolePermissions(MeshVertex sourceNode, MeshVertex targetNode);
	 ...
	 * @return Fluent API
	 */
	AUser setResetToken(String token);
	 ...
	 * @return
	 */
	AUser setForcedPasswordChange(boolean force);
	 ...
	 * @return Fluent API
	 */
	AUser setResetTokenIssueTimestamp(Long timestamp);
	 ...
	 * @return Fluent API
	 */
	default AUser invalidateResetToken() {
		setResetToken(null);
	 ...
	 * @return Fluent API
	 */
	AUser setAPITokenId(String code);
	 ...
	 * @return Fluent API
	 */
	default AUser setAPITokenIssueTimestamp() {
	 ...
	 * @return Fluent API
	 */
	AUser setAPITokenIssueTimestamp(Long timestamp);
