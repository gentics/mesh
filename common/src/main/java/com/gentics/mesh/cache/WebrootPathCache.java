...
public interface WebrootPathCache extends MeshCache<String, Path> {
	 ...
	 */
	void store(HibProject project, Branch branch, ContainerType type, String path, Path resolvedPath);
	 ...
	 */
	Path getPath(HibProject project, Branch branch, ContainerType type, String path);
