...
import static com.gentics.mesh.ElementType.SCHEMACONTAINER;
...
public interface SchemaContainer extends GraphFieldSchemaContainer<SchemaResponse, SchemaReference, SchemaContainer, SchemaContainerVersion> {
	...
	TypeInfo TYPE_INFO = new TypeInfo(SCHEMACONTAINER, SCHEMA_CREATED, SCHEMA_UPDATED, SCHEMA_DELETED);
