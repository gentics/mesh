 ...
 */
public interface S3Binary extends MeshVertex {
	 ...
	 * @return Fluent API
	 */
	default S3Binary setSize(Long sizeInBytes) {
	...
	default S3Binary setS3ObjectKey(String s3objectKey) {
	...
	default S3Binary setMimeType(String mimeType) {
	 ...
	 * @return Fluent API
	 */
	default S3Binary setImageWidth(Integer width) {
	 ...
	 * @return
	 */
	TraversalResult<? extends S3BinaryGraphField> findFields();
