...
public interface ImageManipulator {
	 ...
	 * 
	 * @param field
	 *            Binary field which contains the binary data of the image which should be resized
	 * @param imageRequestParameter
	 * @return
	 */
	Single<PropReadFileStream> handleResize(BinaryGraphField field, ImageManipulationParameters imageRequestParameter);
