...
public abstract class AbstractClusterTest {
	...
	protected MeshDockerServer addSlave(String clusterName, String nodeName) {
		MeshDockerServer server = new MeshDockerServer(clusterName, nodeName, false, true, vertx, null);
		server.start();
		return server;
	}
