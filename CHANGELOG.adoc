...
icon:check[] GraphQL: When using graphql v2 to fetch a node and one of the schemas contained an S3 binary field, the GraphQL endpoint would return a 500 error. This has been fixed.
