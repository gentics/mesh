...
In the future, it will be possible to make alternative implementations of the persistence API, which use other
databases (like relational databases for example).
____
