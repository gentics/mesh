...
icon:check[] REST: Unset properties in schema updates won't cause changes anymore. link:https://github.com/gentics/mesh/issues/496[#496] link:https://github.com/gentics/mesh/issues/165[#165]
