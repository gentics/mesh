...
CAUTION: Fetching fields of a node in GraphQL requires a different syntax. Please refer to the link:https://github.com/gentics/mesh/issues/428[Github issue] for details.
