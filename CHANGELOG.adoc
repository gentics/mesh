...
icon:check[] Plugins: A `NullPointerException` has been fixed which happend when accessing `rc.user().principal()` within a plugin. link:https://github.com/gentics/mesh/issues/516[#516]
