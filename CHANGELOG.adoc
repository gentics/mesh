...
icon:check[] REST: Reading a node via REST with a numerical published version (e.g. 1.0) is now allowed if the user has read published permissions. link:https://github.com/gentics/mesh/issues/71[#71]
