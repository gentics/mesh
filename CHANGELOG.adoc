...
CAUTION: Fetching fields of a node/micronode in GraphQL requires a different syntax. Please refer to the link:https://github.com/gentics/mesh/issues/428[#428] and link:https://github.com/gentics/mesh/issues/317[#317] for details.
