...
icon:plus[] Clustering: The coordinator request processor plane feature has been added. The processor plan can be enabled to efficiently process REST requests in a multi-master and master-replica cluster setup.
...
icon:check[] OrientDB: The included OrientDB version has been updated to version `3.0.29`.
