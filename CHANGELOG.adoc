...
icon:check[] Improved performance and stability. link:https://github.com/gentics/mesh/pull/940[#940]

icon:check[] Fixed a bug that caused Elasticsearch field mappings to not be applied if a new field has been added to an existing schema.
