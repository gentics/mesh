...
CAUTION: With the update to Vert.x 3.9.12, creating a StaticHandler in a plugin to server static files from the plugin's classpath does not work any more.
