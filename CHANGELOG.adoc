...
CAUTION: The previously deprecated support for embedded Elasticsearch in `mesh-server` has been removed. The embedded ES can no longer be used with `mesh-server`.
