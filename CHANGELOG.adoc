...
icon:plus[] Migration: The node migration performance has been greatly enhanced.
...
icon:check[] UI: Fixed potential encoding issues in the UI on systems which are not using the UTF-8 default charset.
