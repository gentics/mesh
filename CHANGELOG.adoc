...
The plugin API has been overhauled and existing plugins need to be migrated link:{{< relref "plugin-migration.asciidoc" >}}[(Migration Guide)] to the new API in order to be deployable.
