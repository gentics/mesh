...
The mapper script support has been dropped due to deprecation of the Nashorn JavaScript engine. The functionality of mapper scripts can be replaced by usage of the new link:{{< relref "plugin-types/auth-service-plugin.asciidoc" >}}[Authentication Service Plugin API].
...
icon:plus[] Core: The core Dagger library was updated to from version `2.11` to `2.24`.
...
* link:{{< relref "guides/mesh-plugin" >}}[Example Plugin Guide]
