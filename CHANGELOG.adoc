...
icon:plus[] Schema validation - Schema and microschema field names must only contain letter, number or underscore characters. link:https://github.com/gentics/mesh/issues/121[#121]
