...
icon:plus[] Search: The `/api/v1/rawSearch/..` and `/api/v1/:projectName/rawSearch/..` endpoints have been added. These endpoint can be used to invoke search requests which will return the raw elasticsearch response JSON. 
