...
CAUTION: Database revision was updated due to OrientDB update. Thus only an offline update can be performed.
...
icon:check[] Core: Deleting language versions of node will no longer create inconsistencies.

icon:check[] Core: Projects containing multiple releases can now be deleted without error.
