...
Starting with version 3.0.0 OrientDB is no longer part of Gentics Mesh, and is replaced by RDBMS-based solutions. The integration with link:https://mariadb.org/[MariaDB] is link:https://www.gentics.com/mesh/docs/getting-started/#_use_mariadb_connected_container[available for public use].

[[v3.0.x]]
== 3.0.x Changelog

Mesh 3.0.x is part of the Gentics Content Management Platform 8.2: link:https://www.gentics.com/cmp/changelog/8.2.0/merged_changelog.html?show=mesh,meshplugins[Changelog]

[[v2.1.x]]
== 2.1.x Changelog

Mesh 2.1.x is part of the Gentics Content Management Platform 8.1: link:https://www.gentics.com/cmp/changelog/8.1.0/merged_changelog.html?show=mesh,meshplugins[Changelog]

[[v2.0.x]]
== 2.0.x Changelog

Mesh 2.0.x is part of the Gentics Content Management Platform 8.0: link:https://www.gentics.com/cmp/changelog/8.0.0/merged_changelog.html?show=mesh,meshplugins[Changelog]
