...
icon:plus[] Monitoring: Metrics have been added for the synchronized write lock and the topology lock. Take a look at our link:{{< relref "monitoring.asciidoc" >}}#_metrics[documentation] for more information.
