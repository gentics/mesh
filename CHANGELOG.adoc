...
icon:plus[] Clustering: It is now possible to configure the public network host within `mesh.yml` file via `cluster.publicHost` or via the environment setting `MESH_CLUSTER_PUBLIC_NETWORK_HOST`.
