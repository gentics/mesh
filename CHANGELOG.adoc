...
icon:plus[] Core: The hazelcast version was updated from `3.10.4` to `3.11.6`

icon:plus[] Core: The hazelcast kubernetes plugin version was updated from `1.2.2` to `1.5.3`
