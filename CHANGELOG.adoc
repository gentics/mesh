...
This version of Gentics Mesh contains the a new UI which is accessible via `/ui`. The old UI is still part of this release and can be accessed via `/mesh-ui`.
____
