...
Various link:https://github.com/gentics/mesh-plugin-examples[plugin examples] and a link:{{< relref "guides/mesh-plugin" >}}[plugin development guide] has been created.
