...
CAUTION: Custom node migration scripts have been removed. The script system was a source of possible errors and performance problems. The nashorn javascript engine has been deprecated with the release of Java 11. To change for a migration, use the REST api instead.
