...
icon:check[] Image: The focal point resize returned a slighly skewed image when using the `fpz` zoom factor. link:https://github.com/gentics/mesh/issues/272[#272]
