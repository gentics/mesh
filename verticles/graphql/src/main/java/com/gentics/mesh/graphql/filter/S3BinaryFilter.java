 ...
 *
 */
public class S3BinaryFilter extends ImageDataFilter<S3Binary> {
	...
	@Override
	public List<FilterField<S3Binary, ?>> getFilters() {
		List<FilterField<S3Binary, ?>> filters = super.getFilters();
