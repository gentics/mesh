...
icon:plus[] Search: The memory footprint of the differential sync mechanism has been reduced. The sync will now utilize partitions. The size of the partitions can be influenced via the `search.syncBatchSize` setting.
