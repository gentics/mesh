...
public class HtmlListFieldTest extends AbstractFieldTest<ListFieldSchema> {
	...
	public void testFieldTransformation() throws Exception {
		...
		try (Tx tx = tx()) {
			...
			HtmlFieldList htmlList = container.createHTMLList(HTML_LIST);
	...
	public void testFieldUpdate() throws Exception {
		try (Tx tx = tx()) {
			...
			HtmlFieldList list = container.createHTMLList(HTML_LIST);
			assertNotNull(list);
	...
	public void testClone() {
		try (Tx tx = tx()) {
			NodeFieldContainer container = CoreTestUtils.createContainer(createFieldSchema(true));
			HtmlFieldList testField = container.createHTMLList(HTML_LIST);
	...
	public void testEquals() {
		try (Tx tx = tx()) {
			...
			HtmlFieldList fieldA = container.createHTMLList("fieldA");
			HtmlFieldList fieldB = container.createHTMLList("fieldB");
	...
	public void testEqualsNull() {
		try (Tx tx = tx()) {
			NodeFieldContainer container = CoreTestUtils.createContainer(createFieldSchema(true));
			HtmlFieldList fieldA = container.createHTMLList(HTML_LIST);
			assertFalse(fieldA.equals((FieldModel) null));
			assertFalse(fieldA.equals((HtmlFieldList) null));
		}
	}
	...
	public void testUpdateFromRestValidSimpleValue() {
		try (Tx tx = tx()) {
			...
			invokeUpdateFromRestValidSimpleValueTestcase(HTML_LIST, FILLTEXT, (container) -> {
				...
				HtmlFieldList field = container.getHTMLList(HTML_LIST);
