...
public abstract class AbstractGraphQLEndpointTest extends AbstractMeshTest {
	...
	protected void prepareNodes(MeshRestClient client, boolean withMicroschema, boolean withBranchPathPrefix) throws Exception {
		...
		createLanguageLinkResolvingNode(client, NODE_WITH_LINKS_UUID, baseNodeUuid, CONTENT_UUID).blockingAwait();
	...
	protected MeshRequest<GraphQLResponse> makeTheQuery(MeshRestClient client, String queryName, String apiVersion, String version) throws IOException {
		...
		return client.graphqlQuery(PROJECT_NAME, query, new VersioningParametersImpl().setVersion(version));
	}

	protected void testTheQuery(GraphQLResponse response, String queryName, String apiVersion, Consumer<JsonObject> assertion) throws IOException {
	...
	protected Completable createLanguageLinkResolvingNode(MeshRestClient client, String nodeUuid, String parentUuid, String referencedUuid) throws Exception {
