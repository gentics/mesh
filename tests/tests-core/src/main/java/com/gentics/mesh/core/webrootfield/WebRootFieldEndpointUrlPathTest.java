...
public class WebRootFieldEndpointUrlPathTest extends AbstractMeshTest {
	...
	public void testUrlPathResolving() {
		...
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", niceUrlPath)).getResponseAsPlainText(), "slugValue");

		// Now verify that no published node can be found
		call(() -> client().webrootField(PROJECT_NAME, "slug", niceUrlPath, new VersioningParametersImpl().published()), NOT_FOUND, "node_not_found_for_path",
				niceUrlPath);
	}
	...
	public void testUrlPathListResolving() {
		...
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", niceUrlPath)).getResponseAsPlainText(), "slugValue");
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url")).getResponseAsPlainText(), "slugValue");
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/middle")).getResponseAsPlainText(), "slugValue");
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/last/segment")).getResponseAsPlainText(), "slugValue");
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/slugValue")).getResponseAsPlainText(), "slugValue");
	...
	public void testPublishUrlFieldNode() {
		...
		call(() -> client().publishNode(PROJECT_NAME, uuid));
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url")).getResponseAsPlainText(), "slugValue");
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url", new VersioningParametersImpl().published())).getResponseAsPlainText(), "slugValue");
		call(() -> client().takeNodeLanguageOffline(PROJECT_NAME, uuid, "en"));
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url")).getResponseAsPlainText(), "slugValue");
		call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url", new VersioningParametersImpl().published()), NOT_FOUND,
	...
	public void testMultiLanguageFieldHandling() {
		...
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url2")).getResponseAsPlainText(), "slugValue");
		assertEquals(call(() -> client().webrootField(PROJECT_NAME, "slug", "/some/other/url")).getResponseAsPlainText(), "slugValue");
