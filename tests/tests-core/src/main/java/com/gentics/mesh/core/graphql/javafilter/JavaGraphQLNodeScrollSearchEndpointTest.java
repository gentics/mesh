...
public class JavaGraphQLNodeScrollSearchEndpointTest extends GraphQLNodeScrollSearchEndpointTest {

	public JavaGraphQLNodeScrollSearchEndpointTest(String queryName) {
		super(queryName);
	}
