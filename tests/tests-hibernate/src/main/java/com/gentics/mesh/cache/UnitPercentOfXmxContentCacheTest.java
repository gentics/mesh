...
@MeshTestSetting(testSize = FULL, startServer = true, customOptionChanger = UnitPercentOfXmxContentCacheTest.class)
public class UnitPercentOfXmxContentCacheTest extends AbstractAutoOptionContentCacheTest {
