...
@MeshTestSetting(elasticsearch = TRACKING, testSize = FULL, startServer = true, customOptionChanger = NodeMassiveRandomPublishTestCached.class)
@Category({FailingTests.class})
// Not actually failing, but may last long
public class NodeMassiveRandomPublishTestCached extends AbstractMassivePublishTest implements MeshOptionChanger {
