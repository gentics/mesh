...
public interface AdminClientMethods {
	 ...
	 * @return
	 */
	MeshRequest<CoordinatorConfigModel> loadCoordinationConfig();
	 ...
	 * @return
	 */
	MeshRequest<CoordinatorConfigModel> updateCoordinationConfig(CoordinatorConfigModel coordinatorConfig);
