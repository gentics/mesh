...
public abstract class MeshRestHttpClientImpl extends AbstractMeshRestHttpClient {
	...
	@Override
	public MeshRequest<SchemaResponse> updateSchema(String uuid, SchemaUpdateRequest request, ParameterProvider... parameters) {
		Objects.requireNonNull(uuid, "uuid must not be null");
		return prepareRequest(POST, "/schemas/" + uuid + getQuery(parameters), SchemaResponse.class, request);
	}
	...
	@Override
	public MeshRequest<MicroschemaResponse> updateMicroschema(String uuid, MicroschemaUpdateRequest request, ParameterProvider... parameters) {
		Objects.requireNonNull(uuid, "uuid must not be null");
		return prepareRequest(POST, "/microschemas/" + uuid + getQuery(parameters), MicroschemaResponse.class, request);
	}
