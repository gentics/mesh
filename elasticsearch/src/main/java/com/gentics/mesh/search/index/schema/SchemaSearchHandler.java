...
public class SchemaSearchHandler extends AbstractSearchHandler<HibSchema, SchemaResponse> {
	...
	@Inject
	public SchemaSearchHandler(Database db, SearchProvider searchProvider, SchemaContainerIndexHandlerImpl indexHandler, AbstractMeshOptions options, SchemaDAOActions actions) {
