...
public abstract class AbstractODBDaoWrapper<T extends HibBaseElement> implements Dao<T> {

	protected final Lazy<ODBBootstrapInitializer> boot;

	protected final Lazy<PermissionPropertiesImpl> permissions;

	public AbstractODBDaoWrapper(Lazy<ODBBootstrapInitializer> boot, Lazy<PermissionPropertiesImpl> permissions) {
		this.boot = boot;
