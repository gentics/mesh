...
public class S3BinaryDaoWrapperImpl extends AbstractDaoWrapper<S3HibBinary> implements S3BinaryDaoWrapper {
	...
	@Inject
	public S3BinaryDaoWrapperImpl(Lazy<BootstrapInitializer> boot, Lazy<PermissionPropertiesImpl> permissions, S3Binaries s3binaries) {
	...
	@Override
	public S3HibBinary findByUuidGlobal(String uuid) {
