...
public class DynamicNonTransformablePageImpl<T extends HibCoreElement> extends AbstractDynamicPage<T> {
	...
	private Predicate<? super T> extraFilter;

	private boolean frameExplicitly;

	private DynamicNonTransformablePageImpl(HibUser requestUser, PagingParameters pagingInfo, Predicate<? super T> extraFilter, boolean frameExplicitly) {
		super(pagingInfo);
	 ...
	 */
	public DynamicNonTransformablePageImpl(HibUser requestUser, RootVertex<? extends T> root, PagingParameters pagingInfo) {
