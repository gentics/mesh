 ...
 * @param <T>
 */
public interface SchemaChange<T extends FieldSchemaContainer> extends BaseElement {
	 ...
	 * @return
	 */
	<R extends FieldSchemaVersionElement<?, ?, ?, ?, ?>> R getNextContainerVersion();
	 ...
	 * @return
	 */
	<R extends FieldSchemaVersionElement<?, ?, ?, ?, ?>> R getPreviousContainerVersion();
	 ...
	 * @return Fluent API
	 */
	SchemaChange<T> setPreviousContainerVersion(FieldSchemaVersionElement<?, ?, ?, ?, ?> containerVersion);
	 ...
	 * @return
	 */
	SchemaChange<T> setNextSchemaContainerVersion(FieldSchemaVersionElement<?, ?, ?, ?, ?> containerVersion);
	 ...
	 */
	Map<String, FieldModel> createFields(FieldSchemaContainer oldSchema, FieldContainerModel oldContent);
