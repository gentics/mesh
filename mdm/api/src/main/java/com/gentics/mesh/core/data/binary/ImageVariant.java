 ...
 *
 */
public interface ImageVariant extends ImageDataElement {
	 ...
	 * @return
	 */
	Result<? extends BinaryField> findFields();
	...
	/**
	 * Get focal point coordinates in the form of {@link FocalPointModel}, or null if inapplicable.
	 * 
	 * @return
	 */
	default FocalPointModel getFocalPoint() {
		...
		if (x == null || y == null) {
			...
			return new FocalPointModel(x, y);
		}
	}
	 ...
	 * @return
	 */
	ImageVariant fillFromManipulation(Binary binary, ImageManipulation variant);
