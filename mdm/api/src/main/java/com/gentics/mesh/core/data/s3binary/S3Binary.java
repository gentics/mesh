 ...
 */
public interface S3Binary extends ImageDataElement, AntivirableBinaryElement {
	 ...
	 * @return S3HibBinary
	 */
	S3Binary setMimeType(String mimeType);
	 ...
	 * @return
	 */
	S3Binary setS3ObjectKey(String s3ObjectKey);
	 ...
	 * @return
	 */
	S3Binary setFileName(String fileName);
