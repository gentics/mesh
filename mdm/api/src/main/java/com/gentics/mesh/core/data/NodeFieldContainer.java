 ...
 */
public interface NodeFieldContainer extends FieldContainer, EditorTracking, BucketableElement {
	 ...
	 */
	Iterable<NodeFieldContainer> getNextVersions();
	 ...
	 * @param container
	 */
	void setNextVersion(NodeFieldContainer container);
	 ...
	 */
	NodeFieldContainer getPreviousVersion();
	 ...
	 *            container
	 */
	void clone(NodeFieldContainer container);
	...
	@Override
	default Stream<NodeFieldContainer> getContents(boolean lookupInFields, boolean lookupInLists) {
