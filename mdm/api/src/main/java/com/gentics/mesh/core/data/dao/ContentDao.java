...
// TODO get rid of "graph" mentions in the names and comments
public interface ContentDao {
	...
	default String getDocumentId(HibNodeFieldContainer content) {
		return ContentDao.composeDocumentId(getParentNode(content).getUuid(), getLanguageTag(content));
	}
	 ...
	 * @return
	 */
	HibNode getParentNode(HibNodeFieldContainer content);
