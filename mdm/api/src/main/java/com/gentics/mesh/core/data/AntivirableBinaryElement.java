 ...
 *
 */
public interface AntivirableBinaryElement extends BinaryDataElement {
	 ...
	 * @return Fluent API.
	 */
	AntivirableBinaryElement setCheckStatus(BinaryCheckStatus checkStatus);
	 ...
	 * @return Fluent API.
	 */
	AntivirableBinaryElement setCheckSecret(String checkSecret);
}
