 ...
 *
 */
public interface BinaryDataField extends Field {
	 ...
	 * @return Fluent API
	 */
	BinaryDataField setFileName(String fileName);
	 ...
	 * @return Fluent API
	 */
	BinaryDataField setMimeType(String mimeType);
