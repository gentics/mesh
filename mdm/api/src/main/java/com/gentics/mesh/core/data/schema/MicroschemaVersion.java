 ...
 */
public interface MicroschemaVersion
	extends FieldSchemaVersionElement<MicroschemaResponse, MicroschemaVersionModel, MicroschemaReference, Microschema, MicroschemaVersion> {
	...
	Microschema getSchemaContainer();

	// TODO MDM rename method
	void setSchemaContainer(Microschema container);
	 ...
	 * 
	 */
	MicroschemaVersion getPreviousVersion();
	 ...
	 */
	MicroschemaVersion getNextVersion();
	 ...
	 * @param version
	 */
	void setNextVersion(MicroschemaVersion version);
