 ...
 *
 */
public interface ImageDataField extends BinaryDataField {
	 ...
	 * @return Fluent API
	 */
	ImageDataField setImageDominantColor(String dominantColor);
	 ...
	 */
	FocalPointModel getImageFocalPoint();
	 ...
	 * @param point
	 */
	ImageDataField setImageFocalPoint(FocalPointModel point);
	 ...
	 * @param loc
	 */
	default void setLocation(LocationModel loc) {
	...
	/**
	 * Return the {@link BinaryMetadataModel} REST model of the field.
	 *
	 * @return
	 */
	default BinaryMetadataModel getMetadata() {
