...
// TODO remove "graph" in namings and comments
public interface HibNode extends HibCoreElement, HibCreatorTracking, HibBucketableElement, HibTransformableElement<NodeResponse> {
	 ...
	 * @return
	 */
	HibNodeFieldContainer getGraphFieldContainer(String languageTag, HibBranch branch, ContainerType type);
	 ...
	 * @return
	 */
	HibNodeFieldContainer getGraphFieldContainer(String languageTag);
	 ...
	 * @return
	 */
	HibNodeFieldContainer getGraphFieldContainer(String languageTag, String branchUuid, ContainerType type);
	 ...
	 * @return
	 */
	HibNodeFieldContainer createGraphFieldContainer(String languageTag, HibBranch branch, HibUser user);
	 ...
	 */
	HibNodeFieldContainer createGraphFieldContainer(String languageTag, HibBranch branch, HibUser editor, HibNodeFieldContainer original,
	 ...
	 * @return
	 */
	default Result<HibNodeFieldContainer> getDraftGraphFieldContainers() {
	 ...
	 * @return
	 */
	default Result<HibNodeFieldContainer> getGraphFieldContainers(HibBranch branch, ContainerType type) {
	 ...
	 * @return
	 */
	Result<HibNodeFieldContainer> getGraphFieldContainers(String branchUuid, ContainerType type);
	 ...
	 * @return
	 */
	Result<HibNodeFieldContainer> getGraphFieldContainers(ContainerType type);
