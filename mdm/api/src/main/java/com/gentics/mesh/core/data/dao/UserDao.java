...
public interface UserDao extends Dao<HibUser>, DaoTransformable<HibUser, UserResponse> {
	...
	/**
	 * Same as {@link UserDao#update(InternalActionContext, EventQueueBatch)}, but does not actually perform any changes.
	 *
	 ...
	 * @param targetElement
	 *            Element to which the CRUD permissions will be assigned.
	 * @return Fluent API
	 */
	HibUser addCRUDPermissionOnRole(HibUser user, HasPermissions sourceNode, InternalPermission permission, HibBaseElement targetElement);
	 ...
	 * @return Fluent API
	 */
	HibUser addPermissionsOnRole(HibUser user, HasPermissions sourceNode, InternalPermission permission, HibBaseElement targetElement,
