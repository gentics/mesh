 ...
 */
@Singleton
public class ArcadeDBHighLevelChangesList extends HighLevelChangesList {
	...
	@Inject
	public ArcadeDBHighLevelChangesList(ExtractPlainText plainText, SetAdminUserFlag setAdminUserFlag, RestructureWebrootIndex restructureWebroot, FixNodeVersionOrder fixNodeVersionOrder, RemoveDupIndex removeDupIndex) {
