 ...
 */
@Singleton
public class ArcadeDBAdminHandler extends AdminHandler {

	@Inject
	public ArcadeDBAdminHandler(Vertx vertx, Database db, RouterStorageImpl routerStorage, BootstrapInitializer boot,
