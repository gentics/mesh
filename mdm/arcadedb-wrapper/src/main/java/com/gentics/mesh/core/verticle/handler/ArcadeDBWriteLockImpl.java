 ...
 */
@Singleton
public class ArcadeDBWriteLockImpl extends AbstractGenericWriteLock {

	private final GraphDBMeshOptions options;

	@Inject
	public ArcadeDBWriteLockImpl(GraphDBMeshOptions options, Lazy<HazelcastInstance> hazelcast, MetricsService metricsService, ClusterManager clusterManager) {
