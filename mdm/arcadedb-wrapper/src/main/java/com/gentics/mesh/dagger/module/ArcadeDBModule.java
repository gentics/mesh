...
import com.gentics.mesh.cache.ArcadeDBCacheRegistry;
...
import com.gentics.mesh.changelog.highlevel.ArcadeDBHighLevelChangesList;
...
import com.gentics.mesh.cli.ArcadeDBBootstrapInitializerImpl;
...
import com.gentics.mesh.core.db.cluster.DefaultClusterManagerImpl;
import com.gentics.mesh.core.endpoint.admin.AdminHandler;
import com.gentics.mesh.core.endpoint.admin.ArcadeDBAdminHandler;
...
import com.gentics.mesh.core.verticle.handler.ArcadeDBWriteLockImpl;
...
import com.gentics.mesh.graphdb.dagger.ArcadeDBCoreModule;
...
/**
 * Dagger module for ArcadeDB specific dependencies.
 */
@Module(includes = { ArcadeDBCoreModule.class })
public abstract class ArcadeDBModule {

	@Binds
	abstract HighLevelChangesList highLevelChangesList(ArcadeDBHighLevelChangesList e);
	...
	@Binds
	abstract Database bindDatabase(ArcadeDBDatabase e);

	@Binds
	abstract GraphDatabase bindGraphDatabase(ArcadeDBDatabase e);

	@Binds
	abstract BootstrapInitializer bindBootstrapInitializer(ArcadeDBBootstrapInitializerImpl e);
	...
	@Binds
	abstract WriteLock bindWriteLock(ArcadeDBWriteLockImpl e);
	...
	@Binds
	abstract AdminHandler adminHandler(ArcadeDBAdminHandler e);
	...
	@Binds
	abstract CacheRegistry bindCacheRegistry(ArcadeDBCacheRegistry e);
	...
	@Binds
	abstract ClusterManager bindClusterManager(DefaultClusterManagerImpl e);

	@Binds
	abstract GraphDBBootstrapInitializer arcadeDBBootstrapInitializer(ArcadeDBBootstrapInitializerImpl e);

	@Provides
	public static GraphDBMeshOptions arcadeDBMeshOptions(MeshOptions meshOptions) {
	...
	/**
	 * Return the hazelcast instance which is fetched from ArcadeDB cluster manager.
	 *
	...
	@Provides
	@Singleton
	public static HazelcastInstance hazelcast(ClusterManager clusterManager) {
