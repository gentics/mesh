...
public interface PersistingNodeDao extends NodeDao, PersistingRootDao<HibProject, HibNode> {
     ...
     *
     * @param ac
     * @param branch   Use the given branch to identify the branch specific parent node
     * @param restNode Model to be updated
     * @return
     */
     ...
     *
     * @param ac
     * @param branch       Branch which will be used to locate the correct field container
     * @param restNode     Rest model which will be updated
     * @param level        Current level of transformation
     * @param fieldsSet
     * @param languageTags
     * @return
     */
