...
public class SchemaVersionPurgeJobProcessor extends AbstractContainerVersionPurgeJobProcessor<SchemaResponse, SchemaVersionModel, SchemaReference, HibSchema, HibSchemaVersion, SchemaModel> {
