...
@NamedQueries({
	...
	@NamedQuery(
			name = "micronodefieldref.countContent",
			query =  "select edge.microschemaVersion.dbUuid, count(edge.valueOrUuid) from micronodefieldref edge group by edge.microschemaVersion"),
	@NamedQuery(
