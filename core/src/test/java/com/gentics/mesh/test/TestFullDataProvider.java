...
public class TestFullDataProvider implements TestDataProvider {
	...
	private static TestFullDataProvider instance;

	public static TestFullDataProvider getInstance() {
		return instance;
	}
	...
	@Inject
	public TestFullDataProvider(BootstrapInitializer boot, Database database) {
		this.boot = boot;
		this.db = database;
		instance = this;
	}
