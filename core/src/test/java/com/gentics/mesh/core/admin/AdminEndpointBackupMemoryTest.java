...
@MeshTestSetting(elasticsearch = NONE, testSize = FULL, startServer = true, startStorageServer = true, clusterMode = false, inMemoryDB = true, optionsProvider = OrientDBMeshOptionsProvider.class)
