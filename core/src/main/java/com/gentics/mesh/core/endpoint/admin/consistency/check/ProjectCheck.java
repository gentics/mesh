...
public class ProjectCheck extends AbstractConsistencyCheck {
	...
	private void checkProject(Project project, ConsistencyCheckResult result) {
		...
		checkOut(project, HAS_SCHEMA_ROOT, ProjectSchemaRootImpl.class, result, HIGH);
		checkOut(project, HAS_MICROSCHEMA_ROOT, ProjectMicroschemaRootImpl.class, result, HIGH);
