...
//
//	public void handleListByTag(String projectName, RoutingContext rc, NodeListTagCallable clc) {
//		MeshAuthUser requestUser = getUser(rc);
//
//		NodeListResponse listResponse = new NodeListResponse();
//		List<String> languageTags = getSelectedLanguageTags(rc);
//
//		loadObject(rc, "uuid", READ_PERM, TagImpl.class, (AsyncResult<Tag> rh) -> {
//			Tag tag = rh.result();
//
...
//	}
//
//	public void handleNodeList(String projectName, RoutingContext rc, NodeListNodeCallable clc) {
//		MeshAuthUser requestUser = getUser(rc);
//
//		NodeListResponse listResponse = new NodeListResponse();
//		List<String> languageTags = getSelectedLanguageTags(rc);
