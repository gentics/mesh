 ...
 */
public class AdminEndpointImpl extends AbstractInternalEndpoint implements AdminEndpoint {
	...
	@Inject
	public AdminEndpointImpl(MeshAuthChainImpl chain, AdminHandler adminHandler, JobHandler jobHandler, ConsistencyCheckHandler consistencyHandler,
