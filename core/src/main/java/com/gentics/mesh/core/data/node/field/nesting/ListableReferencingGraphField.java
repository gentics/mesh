...
/**
 * Listable referencing graph fields are fields which are modeled using a graph edge instead of a vertex. Typical example fields are {@link NodeGraphField} and
