 ...
 * {@link MicroschemaModel}. This way {@link SchemaChange} operations can be applied on a given schema.
 */
public class FieldSchemaContainerMutator {
	 ...
	 * @return
	 */
	public <RM extends FieldSchemaContainer> RM apply(HibFieldSchemaVersionElement<RM> containerVersion) {
