...
public class S3BinaryGraphFieldImpl extends MeshEdgeImpl implements S3BinaryGraphField {
	...
	public static FieldUpdater S3_BINARY_UPDATER = (container, ac, fieldMap, fieldKey, fieldSchema, schema) -> {
		...
		if (graphS3BinaryField == null && s3ObjectKey != null) {
			S3Binary binary = mesh.s3binaries().findByS3ObjectKey(s3ObjectKey).runInExistingTx(Tx.get());
			if (binary != null) {
		...
		if (newFocalPoint != null) {
			S3Binary binary = graphS3BinaryField.getS3Binary();
	...
	public void removeField(BulkActionContext bac, GraphFieldContainer container) {
		S3Binary graphBinary = getS3Binary();
		remove();
	...
	public GraphField cloneTo(GraphFieldContainer container) {
		S3BinaryGraphFieldImpl field = getGraph().addFramedEdge(container, getS3Binary(), HAS_FIELD, S3BinaryGraphFieldImpl.class);
	...
	public boolean equals(Object obj) {
		if (obj instanceof S3BinaryGraphField) {
			...
			S3Binary s3binaryA = getS3Binary();
			S3Binary s3binaryB = s3binaryField.getS3Binary();
