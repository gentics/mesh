...
public abstract class AbstractGraphFieldContainerImpl extends AbstractBasicGraphFieldContainerImpl implements GraphFieldContainer {
	...
	@Override
	public S3BinaryGraphField createS3Binary(String fieldKey, S3Binary s3binary) {
		S3BinaryGraphField edge = addFramedEdge(HAS_FIELD, s3binary, S3BinaryGraphFieldImpl.class);
		edge.setFieldKey(fieldKey);
		return edge;
	}
