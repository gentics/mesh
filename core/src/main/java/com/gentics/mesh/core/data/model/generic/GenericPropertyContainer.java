...
public class GenericPropertyContainer extends GenericNode {
	...
	public List<I18NProperties> getI18nProperties() {
	...
	public I18NProperties createI18nProperties(Language language) {
		...
		try {
			...
			properties = graph().addVertex(I18NProperties.class);
			properties.setLanguage(language);
			Translated edge = addEdge(BasicRelationships.HAS_I18N_PROPERTIES, properties, Translated.class);
