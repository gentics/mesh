...
import com.gentics.mesh.search.*;
...
public abstract class AbstractBootstrapInitializer implements BootstrapInitializer {
	 ...
	 *
	 * @param destination The remote host name or IP
	...
	public void initVertx(MeshOptions options) {
		io.vertx.core.VertxOptions vertxOptions = new VertxOptions();
	 ...
	 * @param isJoiningCluster Flag which indicates that the instance is joining the cluster. In those cases various checks must not be invoked.
	 ...
	 * @param vertxOptions Vert.x options
	 * @param hazelcast    Hazelcast instance which should be used by vert.x
	 */
