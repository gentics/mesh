 ...
 *
 */
public class MeshAuthServiceImpl implements AuthService, Handler<Long> {
	...
	public MeshAuthServiceImpl(Vertx vertx, JsonObject config, ExposingShiroAuthProvider provider) {
		this.vertx = vertx;
