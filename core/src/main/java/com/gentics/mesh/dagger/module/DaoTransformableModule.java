...
/**
 * Provides bindings to conveniently inject a map of daos used for transforming elements.
 * To use the map inject a <code>Map<ElementType, DaoTransformable<HibCoreElement, RestModel>></code>.
 */
@Module
public abstract class DaoTransformableModule {
	...
	public static Map<ElementType, DaoTransformable<HibCoreElement, RestModel>> map(Map<ElementType, DaoTransformable<? extends HibCoreElement, ? extends RestModel>> daos) {
