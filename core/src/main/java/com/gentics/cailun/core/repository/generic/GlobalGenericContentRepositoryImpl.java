...
public class GlobalGenericContentRepositoryImpl implements ContentRepositoryActions<GenericContent> {

	@Override
	public List<GenericContent> findCustomerNodeBySomeStrangeCriteria(Object strangeCriteria) {
