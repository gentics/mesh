 ...
 * A copy of {@link com.arcadedb.gremlin.ArcadeGraphFactory}, extended to expose a single shared Database instance.
 *
...
public class SharedArcadeGraphFactory implements Closeable {
	...
	/**
	   ...
	   */
	  private SharedArcadeGraphFactory(final String host, final int port, final String databaseName, final String userName,
