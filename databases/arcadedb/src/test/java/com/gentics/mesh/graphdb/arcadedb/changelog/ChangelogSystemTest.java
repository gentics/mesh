...
public class ChangelogSystemTest {
	...
	public void testChangelogSystem() throws Exception {
		...
		ArcadeDBDatabase db = getDatabase(options);
	 ...
	 * @return
	 */
	public static ArcadeDBDatabase getDatabase(GraphDBMeshOptions options) {
		...
		ArcadeDBDatabase database = new ArcadeDBDatabase(options, null, null, null, metrics, null, null, null, null, null, null, null, null);
		try {
			database.init(null);
			return database;
		} catch (Exception e) {
