...
| Create a project
| link:++/docs/api#projects__post++[```POST /api/v1/projects/```]

| Get all projects
| link:++/docs/api/##projects__get++[```GET /api/v1/projects/```]

| Get a project
| link:++/docs/api#projects__projectUuid__get++[```GET /api/v1/projects/:projectUuid```]

| Update a project
| link:++/docs/api#projects__projectUuid__post++[```POST /api/v1/projects/:projectUuid```]

| Delete a node
| link:++/docs/api#projects__projectUuid__delete++[```DELETE /api/v1/projects/:projectUuid```]
...
[source,json]
----
include::content/docs/api/response/api/v1/projects/\{projectUuid\}/200/example.json[]
----
...
| Create a new node
| link:++/docs/api#project__nodes__post++[```POST /api/v1/:projectName/nodes```]

| Get all nodes of a project
| link:++/docs/api#project__nodes__get++[```GET /api/v1/:projectName/nodes```]

| Get a node
| link:++/docs/api#project__nodes__nodeUuid__get++[```GET /api/v1/:projectName/nodes/:nodeUuid```]

| Update a node
| link:++/docs/api#project__nodes__nodeUuid__post++[```POST /api/v1/:projectName/nodes/:nodeUuid```]

| Delete a node
| link:++/docs/api#project__nodes__nodeUuid__delete++[```DELETE /api/v1/:projectName/nodes/:nodeUuid```]

| Update an image, video, or document
| link:++/docs/api#project__nodes__nodeUuid__binary__fieldName__post++[```POST /api/v1/:projectName/nodes/:nodeUuid/binary/:fieldName```]

| Get an image, video, or document -  Crop & resize images
| link:++/docs/api#project__nodes__nodeUuid__binary__fieldName__get++[```GET /api/v1/:projectName/nodes/:nodeUuid/binary/:fieldName```]

| Crop & resize and update an image
| link:++/docs/api#project__nodes__nodeUuid__binaryTransform__fieldName__post++[```POST /api/v1/:projectName/nodes/:nodeUuid/binaryTransform/:fieldName```]

| Get all child nodes
| link:++/docs/api#project__nodes__nodeUuid__children_get++[```GET /api/v1/:projectName/nodes/:nodeUuid/children```]

| Delete the language specific content of a node
| link:++/docs/api#project__nodes__nodeUuid__languages__language__delete++[```DELETE /api/v1/:projectName/nodes/:nodeUuid/language/:language```]

| Get the publish status for the given language of a node
| link:++/docs/api#project__nodes__nodeUuid__languages__language__published_get++[```GET /api/v1/:projectName/nodes/:nodeUuid/language/:language/published```]

| Move a node
| link:++/docs/api#project__nodes__nodeUuid__moveTo__toUuid__post++[```POST /api/v1/:projectName/nodes/:nodeUuid/moveTo/:toUuid```]

| Get a navigation object
| link:++/docs/api#project__nodes__nodeUuid__navigation_get++[```GET /api/v1/:projectName/nodes/:nodeUuid/navigation```]

| Get the published status of a node
| link:++/docs/api#project__nodes__nodeUuid__published_get++[```GET /api/v1/:projectName/nodes/:nodeUuid/published```]

| Publish a node
| link:++/docs/api#project__nodes__nodeUuid__published_post++[```POST /api/v1/:projectName/nodes/:nodeUuid/published```]

| Unpublish a node
| link:++/docs/api#project__nodes__nodeUuid__published_delete++[```DELETE /api/v1/:projectName/nodes/:nodeUuid/published```]

| Get the tag list of a node
| link:++/docs/api#project__nodes__nodeUuid__tags_get++[```GET /api/v1/:projectName/nodes/:nodeUuid/tags```]

| Update the tag list of a node
| link:++/docs/api#project__nodes__nodeUuid__tags_post++[```POST /api/v1/:projectName/nodes/:nodeUuid/tags```]

| Tag a node
| link:++/docs/api#project__nodes__nodeUuid__tags__tagUuid__post++[```POST /api/v1/:projectName/nodes/:nodeUuid/tags/:tagUuid```]

| Remove a tag from a node
| link:++/docs/api#project__nodes__nodeUuid__tags__tagUuid__delete++[```DELETE /api/v1/:projectName/nodes/:nodeUuid/tags/:tagUuid```]
...
[source,json]
----
include::content/docs/api/response/api/v1/\{project\}/nodes/\{nodeUuid\}/200/example.json[]
----
...
| Create a schema
| link:++/docs/api#schemas__post++[```POST /api/v1/schemas/```]

| Get all schemas
| link:++/docs/api#schemas__get++[```GET /api/v1/schemas/```]    

| Get a schema
| link:++/docs/api#schemas__schemaUuid__get++[```GET /api/v1/schemas/:schemaUuid```]

| Update a schema
| link:++/docs/api#schemas__schemaUuid__post++[```POST /api/v1/schemas/:schemaUuid```]

| Delete a schema
| link:++/docs/api#schemas__schemaUuid__delete++[```DELETE /api/v1/schema/:schemaUuid```]
...
| link:++/docs/api#schemas__schemaUuid__diff_post++[```POST /api/v1/schema/:schemaUuid/diff```]
...
| link:++/docs/api#schemas__schemaUuid__changes_post++[```POST /api/v1/schema/:schemaUuid/changes```]
...
[source,json]
----
include::content/docs/api/response/api/v1/schemas/\{schemaUuid\}/200/example.json[]
----
...
| link:++/docs/api#microschemas__post++[```POST /api/v1/microschemas/```]

| Get all microschemas
| link:++/docs/api#microschemas__get++[```GET /api/v1/microschemas/```]

| Get a microschema
| link:++/docs/api#microschemas__microschemaUuid__get++[```GET /api/v1/microschemas/:microschemaUuid```]

| Update a microschema
| link:++/docs/api#microschemas__microschemaUuid__post++[```POST /api/v1/microschemas/:microschemaUuid```]

| Delete a microschema
| link:++/docs/api#microschemas__microschemaUuid__delete++[```DELETE /api/v1/microschemas/:microschemaUuid```]
...
| link:++/docs/api#microschemas__microschemaUuid__diff_post++[```POST /api/v1/microschemas/:microschemaUuid/diff```]
...
| link:++/docs/api#microschemas__microschemaUuid__changes_post++[```POST /api/v1/microschemas/:microschemaUuid/changes```]
...
[source,json]
----
include::content/docs/api/response/api/v1/\{project\}/tagFamilies/\{tagFamilyUuid\}/tags/\{tagUuid\}/200/example.json[]
----
...
| link:++/docs/api#project__tagFamilies__get++[```GET /api/v1/:projectName/tagFamilies/```]

| Create a tag family.
| link:++/docs/api#project__tagFamilies__post++[```POST /api/v1/:projectName/tagFamilies/```]

| Get a tag family
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__get++[```GET /api/v1/:projectName/tagFamilies/:tagFamilyUuid```]

| Update a tag family
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__post++[```POST /api/v1/:projectName/tagFamilies/:tagFamilyUuid```]

| Delete a tag family
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__delete++[```DELETE /api/v1/:projectName/tagFamilies/:tagFamilyUuid```]

| Get all tags of a tag family
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__tags_get++[```GET /api/v1/:projectName/tagFamilies/:tagFamilyUuid/tags```]

| Get a specified tag from a tag family
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__tags__tagUuid__get++[```GET /api/v1/:projectName/tagFamilies/:tagFamilyUuid/tags/:tagUuid```]

| Update a specified tag
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__tags__tagUuid__post++[```POST /api/v1/:projectName/tagFamilies/:tagFamilyUuid/tags/:tagUuid```]

| Remove a tag from a tag family
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__tags__tagUuid__delete++[```DELETE /api/v1/:projectName/tagFamilies/:tagFamilyUuid/tags/:tagUuid```]

| Get all nodes that have been tagged with the tag
| link:++/docs/api#project__tagFamilies__tagFamilyUuid__tags__tagUuid__nodes_get++[```GET /api/v1/:projectName/tagFamilies/:tagFamilyUuid/tags/:tagUuid/nodes```]
...
[source,json]
----
include::content/docs/api/response/api/v1/\{project\}/tagFamilies/\{tagFamilyUuid\}/200/example.json[]
----
...
| Get all users
| link:++/docs/api#users__get++[```GET /api/v1/users/```]

| Create a user
| link:++/docs/api#users__post++[```POST /api/v1/users/```]

| Get a user
| link:++/docs/api#users__userUuid__get++[```GET /api/v1/users/:userUuid```]

| Update a user
| link:++/docs/api#users__userUuid__post++[```POST /api/v1/users/:userUuid```]

| Deactivate a user
| link:++/docs/api#users__userUuid__delete++[```DELETE /api/v1/users/:userUuid```]

| Read user permissions on elements
| link:++/docs/api#users__userUuid__permissions__path__get++[```GET /api/v1/users/:userUuid/permissions/:path```]

| Return a one time token to update a user
| link:++/docs/api#users__userUuid__reset_token_post++[```POST /api/v1/users/:userUuid/reset_token```]

| Return an API token
| link:++/docs/api#users__userUuid__token_post++[```POST /api/v1/users/:userUuid/token```]

| Invalidate an API token
| link:++/docs/api#users__userUuid__token_delete++[```DELETE /api/v1/users/:userUuid/token```]
...
[source,json]
----
include::content/docs/api/response/api/v1/users/\{userUuid\}/200/example.json[]
----
...
| Get all groups
| link:++/docs/api#groups__get++[```GET /api/v1/groups/```]

| Create a group
| link:++/docs/api#groups__post++[```POST /api/v1/groups/```]

| Get a group
| link:++/docs/api#groups__groupUuid__get++[```GET /api/v1/group/:groupUuid```]

| Update a group
| link:++/docs/api#groups__groupUuid__post++[```POST /api/v1/group/:groupUuid```]

| Delete a group
| link:++/docs/api#groups__groupUuid__delete++[```DELETE /api/v1/group/:groupUuid```]

| Get all roles assigned to a group
| link:++/docs/api#groups__groupUuid__roles_get++[```GET /api/v1/group/:groupUuid/roles```]

| Assign a role to a group
| link:++/docs/api#groups__groupUuid__roles__roleUuid__post++[```POST /api/v1/group/:groupUuid/roles/:rolesUuid```]

| Remove a role from a group
| link:++/docs/api#groups__groupUuid__roles__roleUuid__delete++[```DELETE /api/v1/group/:groupUuid/roles/:rolesUuid```]

| Get all users assigned to a group
| link:++/docs/api#groups__groupUuid__users_get++[```GET /api/v1/group/:groupUuid/users```]

| Add user to a group
| link:++/docs/api#groups__groupUuid__users__userUuid__post++[```POST /api/v1/group/:groupUuid/users/:userUuid```]

| Remove user from a group
| link:++/docs/api#groups__groupUuid__users__userUuid__delete++[```DELETE /api/v1/group/:groupUuid/users/:userUuid```]
|======
...
[source,json]
----
include::content/docs/api/response/api/v1/groups/\{groupUuid\}/200/example.json[]
----
...
| Get all roles
| link:++/docs/api#roles__get++[```GET /api/v1/roles/```]

| Create a role
| link:++/docs/api#roles__post++[```POST /api/v1/roles/```]

| Get a role
| link:++/docs/api#roles__roleUuid__get++[```GET /api/v1/roles/:roleUuid```]

| Update a role
| link:++/docs/api#roles__roleUuid__post++[```POST /api/v1/roles/:roleUuid```]

| Delete a role
| link:++/docs/api#roles__roleUuid__delete++[```DELETE /api/v1/roles/:roleUuid```]

| Read role permissions on elements
| link:++/docs/api#roles__roleUuid__permissions__path__get++[```GET /api/v1/roles/:roleUuid/permissions/:path```]

| Set role permissions on elements
| link:++/docs/api#roles__roleUuid__permissions__path__post++[```POST /api/v1/roles/:roleUuid/permissions/:path```]
|======
...
[source,json]
----
include::content/docs/api/response/api/v1/roles/\{roleUuid\}/200/example.json[]
----
