...
include::examples/tables/NodeCreateRequest.adoc[]

==== Update Properties

include::examples/tables/NodeUpdateRequest.adoc[]
...
include::examples/tables/SchemaCreateRequest.adoc[]

==== Update Properties

include::examples/tables/SchemaUpdateRequest.adoc[]
...
include::examples/tables/TagCreateRequest.adoc[]

==== Update Properties

include::examples/tables/TagUpdateRequest.adoc[]
...
include::examples/tables/TagFamilyCreateRequest.adoc[]

==== Update Properties

include::examples/tables/TagFamilyUpdateRequest.adoc[]
...
include::examples/tables/UserCreateRequest.adoc[]

==== Update Properties

include::examples/tables/UserUpdateRequest.adoc[]
...
include::examples/tables/GroupCreateRequest.adoc[]

==== Update Properties

include::examples/tables/GroupUpdateRequest.adoc[]
...
| link:raml#roles__roleUuid__permissions__pathToElement__get[```GET /api/v1/roles/:roleUuid```]

| Set role permissions on elements
| link:raml#roles__roleUuid__permissions__pathToElement__post[```POST /api/v1/roles/:roleUuid```]
|======
...
include::examples/tables/RoleCreateRequest.adoc[]

==== Update Properties

include::examples/tables/RoleUpdateRequest.adoc[]
