...
==== Create Properties
include::examples/models/ProjectCreateRequest.adoc[]
==== Update Properties
include::examples/models/ProjectUpdateResquest.adoc[]
...
=== Properties
include::examples/models/SchemaResponse.adoc[]
...
| token
| string
| Token code which can be used to update the user even if the connection is not authenticated. E.g., this can be used to implement a password recovery feature.
