...
[source,json]
----
include::content/docs/examples/api/response/api/v1/projects/\{projectUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/\{project\}/nodes/\{nodeUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/schemas/\{schemaUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/\{project\}/tagFamilies/\{tagFamilyUuid\}/tags/\{tagUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/\{project\}/tagFamilies/\{tagFamilyUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/users/\{userUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/groups/\{groupUuid\}/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/roles/\{roleUuid\}/200/example.json[]
----
