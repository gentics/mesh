...
[source,xml]
----
include::content/examples/graphql-plugin/pom.xml[]
----
...
[source,java]
----
include::content/examples/graphql-plugin/src/main/java/com/gentics/mesh/plugin/GraphQLExamplePlugin.java[]
----
