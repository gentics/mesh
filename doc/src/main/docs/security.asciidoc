...
CAUTION: The following sections are irrelevant, if link:content/premium-features/sql-db/documentation/[SQL RDBMS storage premium feature] is used. Please refer to the feature documentation instead.
