...
[source,json]
----
include::content/docs/examples/api/request/api/v1/admin/plugins/request-body.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/admin/plugins/\{uuid\}/200/example.json[]
----
