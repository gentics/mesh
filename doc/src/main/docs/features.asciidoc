...
Metadata information of uploads will automatically be extracted and added the `metadata` object of the binary field. Currently `jpeg`, `png` and `pdf` files will be processed.
