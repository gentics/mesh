...
The GPS information of images will be processed and provided in a `location` object. A geopoint will automatically be stored for the document in the search index. This way it is possible to run link:https://getmesh.io/docs/beta/elasticsearch.html#_search_nodes_by_geolocation_of_images[geo search queries] to locate images within a specific area.
...
[source,json]
----
include::examples/api/request/api/v1/\{project\}/branches/\{branchUuid\}/schemas/request-body.json[]
----
...
[source,json]
----
include::examples/api/request/api/v1/\{project\}/branches/\{branchUuid\}/microschemas/request-body.json[]
----
