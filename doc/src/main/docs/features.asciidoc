...
The property provides an array of node references representing the path from the project root down to the current node. For more details see the documentation on link:building-blocks.html#_node[node].
...
The GPS information of images will be processed and provided in a `location` object. A geopoint will automatically be stored for the document in the search index. This way it is possible to run link:https://getmesh.io/docs/elasticsearch.html#_search_nodes_by_geolocation_of_images[geo search queries] to locate images within a specific area.
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/\{project\}/nodes/\{nodeUuid\}/published/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/request/api/v1/\{project\}/branches/\{branchUuid\}/schemas/request-body.json[]
----
...
[source,json]
----
include::content/docs/examples/api/request/api/v1/\{project\}/branches/\{branchUuid\}/microschemas/request-body.json[]
----
...
[source,json]
----
include::content/docs/examples/api/request/api/v1/schemas/\{schemaUuid\}/changes/request-body.json[]
----
