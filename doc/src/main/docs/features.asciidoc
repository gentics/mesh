...
There are two properties when defining a http://getmesh.io/docs/beta/building-blocks.html#_schemas[schema] for your nodes that are of importance in this respect.
...
Within the demo project vehicles are organized in three different categories. The nodes _Automobiles_, _Aircrafts_ and _Yachts_ of type _category_ serve as containers for nodes of type _vehicle_, e.g., the node _Trabant_ in category _Automobiles_.
...
The schema _vehicle_ has the ```container``` property set to ```false```. The schema’s ```segmentField``` is again specified to be the ```slug``` field. Thus, the resulting value for the ```path``` property of node _Trabant_ is ```/Automobiles/Trabant```.
...
Instead of relying on UUIDs to link your content, you can use pretty URLs like http://yourapp.com/Automobiles/Trabant. For each node, Gentics Mesh will provide you with a human readable path. 
Likewise, you can query your content using WebRoot paths instead of using UUIDs (see <<webroot,WebRoot API>>).

The ```segmentField``` is used to build the path of a specific node. According to the nodes’ schemas in our <<example,example>>, the path ```/Automobiles/Trabant``` for the node _Trabant_ is built using the _slug_ field of the _vehicle_ node, i.e. _Trabant_, and the _slug_ field of the _category_ node, i.e. _Automobiles_.
...
For more details see the documentation on http://getmesh.io/docs/beta/building-blocks.html#_node[node] and <<webroot,WebRoot API>>, respectively.
...
http://getmesh.io/api/v1/demo/nodes/fd58237c79d64bf198237c79d6bbf107?resolveLinks=short

[source,json]
----
{
  "uuid" : "fd58237c79d64bf198237c79d6bbf107",
  "creator" : {
    "uuid" : "41fb5c7e721246a4bb5c7e721216a449"
  },
  "created" : "2017-05-09T09:54:43Z",
  "editor" : {
    "uuid" : "41fb5c7e721246a4bb5c7e721216a449"
  },
  "edited" : "2017-05-09T09:54:47Z",
  "language" : "en",
  "availableLanguages" : [ "en" ],
  "languagePaths" : {
    "en" : "/Automobiles/Trabant"
  },
  "parentNode" : {
    "projectName" : "demo",
  ...
  "fields" : {
    ...
    "price" : 3000,
    "stocklevel" : 40215,
    "description" : "The Trabant is a car that was produced by former East German auto maker VEB Sachsenring Automobilwerke Zwickau in Zwickau, Saxony",
    "vehicleImage" : {
      "uuid" : "b1a975d9391a4daaa975d9391abdaa4f",
      "path" : "/Vehicle%20Images/trabant.jpg",
      "languagePaths" : {
        "en" : "/Vehicle%20Images/trabant.jpg"
      }
    }
  },
  "path" : "/Automobiles/Trabant",
  "breadcrumb" : [ {
    "projectName" : "demo",
    "uuid" : "ca6c7df3f45b48d4ac7df3f45ba8d42f",
    "displayName" : "Automobiles",
  ...
  "version" : {
    "uuid" : "2455a77d25014d9695a77d25014d967f",
    "number" : "1.0"
  },
  "permissions" : {
    "create" : false,
...
http://getmesh.io/api/v1/demo/nodes/67533414891d4eae933414891d8eaead/navigation?resolveLinks=short&maxDepth=1

[source,json]
----
{
  "uuid" : "67533414891d4eae933414891d8eaead",
  "node" : {
    "uuid" : "67533414891d4eae933414891d8eaead",
    "creator" : {
      "uuid" : "41fb5c7e721246a4bb5c7e721216a449"
    },
    "created" : "2017-05-09T09:54:03Z",
    "editor" : {
      "uuid" : "41fb5c7e721246a4bb5c7e721216a449"
    },
    "edited" : "2017-05-09T09:54:47Z",
    ...
    "childrenInfo" : {
      "folder" : {
        "schemaUuid" : "e287e8a7497940ac87e8a7497940ac82",
        "count" : 1
      },
      "category" : {
    ...
    "breadcrumb" : [ ],
    "version" : {
      "uuid" : "a8716473479f45c4b16473479fe5c4b6",
      "number" : "1.0"
    },
    "permissions" : {
      "create" : false,
  ...
  "children" : [ {
    ...
    "node" : {
      ...
      "path" : "/Vehicle%20Images",
      "breadcrumb" : [ ],
      "version" : {
        "uuid" : "5de952f01ee846d8a952f01ee8f6d891",
        "number" : "1.0"
      },
      "permissions" : {
        "create" : false,
    ...
    "node" : {
      ...
      "breadcrumb" : [ ],
      "version" : {
        "uuid" : "8def8fc6116645d6af8fc6116665d6ac",
        "number" : "1.0"
      },
      "permissions" : {
        "create" : false,
    ...
    "node" : {
      ...
      "breadcrumb" : [ ],
      "version" : {
        "uuid" : "5e84945a87ff4bb584945a87ff0bb5b2",
        "number" : "1.0"
      },
      "permissions" : {
        "create" : false,
    ...
    "node" : {
      ...
      "breadcrumb" : [ ],
      "version" : {
        "uuid" : "aa093788e8514685893788e851f68587",
        "number" : "1.0"
      },
      "permissions" : {
        "create" : false,
...
The property provides an array of node references representing the path from the current node up to the project root. For more details see the documentation on http://getmesh.io/docs/beta/building-blocks.html#_node[node].
...
In our demo app example, the ```breadcrumb``` property for node _Trabant_ will therefore include the node _Automobiles_. 
...
http://getmesh.io/api/v1/demo/webroot/Automobiles/Trabant?resolveLinks=short
...
http://getmesh.io/api/v1/demo/nodes/b1a975d9391a4daaa975d9391abdaa4f/binary/image
...
http://getmesh.io/api/v1/demo/webroot/Vehicle%20Images/trabant.jpg
...
http://getmesh.io/api/v1/demo/nodes/b1a975d9391a4daaa975d9391abdaa4f/binary/image?cropx=10&cropy=100&cropw=800&croph=400&width=300

==== Crop and resize an image with WebRoot path

http://getmesh.io/api/v1/demo/webroot/Vehicle%20Images/trabant.jpg?cropx=10&cropy=100&cropw=800&croph=400&width=300
...
For example, ```{{mesh.link("2f2de9297c8143e8ade9297c8193e8fc", "en")}}``` will be transformed into ```/api/v1/demo/webroot/Vehicle%20Images/ford-gt.jpg``` when using the ```?resolveLinks=full``` query parameter.
...
http://getmesh.io/api/v1/demo/nodes/b1a975d9391a4daaa975d9391abdaa4f/binary/image?width=300
...
http://getmesh.io/api/v1/demo/webroot/Vehicle%20Images/trabant.jpg?cropx=10&cropy=100&cropw=800&croph=400
...
http://getmesh.io/api/v1/demo/nodes/b1a975d9391a4daaa975d9391abdaa4f/binaryTransform/image
...
[[multilanguage]]
== Multi-Language & Language Fallback
...
In order to grasp the concept of versioning in Gentics Mesh it is important to remember that nodes are containers for language variants (see <<multilanguage, Multi-Language & Language Fallback>>). The language variant of a node contains the fields and thus stores all the content.
 
NOTE: Versioning within Gentics Mesh only applies to *language variants* and their referenced fields. Other elements such as users, groups, roles and even nodes are not versioned.
 
Various content management tasks will have different effects for versioning in Gentics Mesh. Following, we go through all of these actions which involve versioning.
...
//TODO move to explanation on what is versioned
