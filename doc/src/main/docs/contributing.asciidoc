...
export JAVA_18_HOME=<PATH-TO-YOUR-JAVA8>
mvn clean package -Denv.JAVA_1_8_HOME=$JAVA_18_HOME -DskipTests -Dskip.unit.tests -Dskip.performance.tests -Dskip.cluster.tests
```
