...
[source,json]
----
include::examples/api/response/api/v1/admin/consistency/check/200/example.json[]
----
...
[source,json]
----
include::examples/api/response/api/v1/admin/consistency/repair/200/example.json[]
----
