...
CAUTION: The `/graphdb` volume is irrelevant, if link:content/premium-features/sql-db/documentation/[SQL RDBMS storage premium feature] is used. Please refer to the feature documentation instead.
