...
[source,json]
----
include::content/docs/examples/models/mesh-config.yml[]
----
...
include::content/docs/includes/cluster-options.inc[]
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/admin/consistency/check/200/example.json[]
----
...
[source,json]
----
include::content/docs/examples/api/response/api/v1/admin/consistency/repair/200/example.json[]
----
