...
CAUTION: This section is irrelevant, if link:content/premium-features/sql-db/documentation/[SQL RDBMS storage premium feature] is used. Please refer to the feature documentation, as well as the clustering documentation for the chosen RDBMS.
