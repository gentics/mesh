...
* `CUD` - In this mode only write requests (Create, Read, Update) will be delegated to the elected master. All other requests will be directly processed by the instance.
