...
include::examples/request/api/v1/:projectName/nodes/NodeCreateRequest.json[]
----
...
include::examples/request/api/v1/:projectName/nodes/:uuid/NodeUpdateRequest.json[]
----
...
[source,json]
----
include::examples/response/api/v1/users/:uuid/200/UserResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/groups/:uuid/200/GroupResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/roles/:uuid/200/RoleResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/projects/:uuid/200/ProjectResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/:projectName/tagFamilies/:uuid/200/TagFamilyResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/:projectName/tagFamilies/:tagFamilyUuid/tags/:uuid/200/TagResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/:projectName/nodes/:uuid/200/NodeResponse.json[]
----
...
[source,json]
----
include::examples/response/api/v1/schemas/:uuid/200/SchemaModel.json[]
----
...
[source,json]
----
include::examples/request/api/v1/schemas/:schemaUuid/changes/SchemaChangesListModel.json[]
----
...
[source,json]
----
include::examples/response/api/v1/:projectName/nodes/:uuid/published/200/PublishStatusResponse.json[]
----
...
[source,json]
----
include::examples/request/api/v1/:projectName/releases/:uuid/schemas/SchemaReferenceList.json[]
----
...
[source,json]
----
include::examples/request/api/v1/:projectName/releases/:uuid/microschemas/MicroschemaReferenceList.json[]
----
