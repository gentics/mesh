...
Again, this functionality builds on top of content trees in Gentics Mesh. To be more specifically, the ```segmentField``` is used to build the path of a specific node. 
