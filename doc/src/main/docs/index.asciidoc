...
==== Overview
Mesh currently supports 2 ways of authentication: Basic auth and Json Web Token (JWT) Auth. A user can be authenticated by setting the Authentication HTTP header in a request.
