...
Structural references for nodes always contain release information. This applies to parent/child relationship or taggings of nodes. This way releases are completely isolated from each other.
...
Gentics Mesh currently does not provide any means of automatically merging releases or nodes from one specific release to another.  
