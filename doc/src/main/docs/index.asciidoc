                ...
                <ul class="doc-toc">
                    <li class="section">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="features.html#_content_branches">Content Branches</a>
                            </li>
                            <li>
                ...
                <ul class="doc-toc">
                    <li class="section">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="authentication.html#_authentication">Authentication</a>
                                <ul>
                                    <li>
                                        <a href="authentication.html#_overview">Overview</a>
                                    </li>
                                    <li>
                                        <a href="authentication.html#_oauth2">OAuth2</a>
                                    </li>
                                    <li>
                                        <a href="authentication.html#_login">Login</a>
                                    </li>
                                    <li>
                                        <a href="authentication.html#_api_token">API Token</a>
                                    </li>
                                    <li>
                                        <a href="authentication.html#_anonymous_access">Anonymous Access</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
