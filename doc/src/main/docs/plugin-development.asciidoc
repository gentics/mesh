...
https://github.com/gentics/mesh-plugin-examples/blob/master/test-common/src/main/java/com/gentics/mesh/plugin/OrientDBMeshLocalServer.java[OrientDBMeshLocalServer]
