...
For the images the `binary` field will provide the segment. This way the filename of the uploaded binary will be used. The image will be loadable via the link:../api/#project__webroot__path__get[/api/v2/demo/webroot/images/sts.jpg?w=800] path.
