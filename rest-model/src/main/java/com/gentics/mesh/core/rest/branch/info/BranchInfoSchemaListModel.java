 ...
 */
public class BranchInfoSchemaListModel implements RestModel {
	 ...
	 */
	public BranchInfoSchemaListModel() {
	}

	public BranchInfoSchemaListModel(List<BranchSchemaInfo> schemas) {
	 ...
	 * @return Fluent API
	 */
	public BranchInfoSchemaListModel add(SchemaReference... references) {
