...
public class NodeUpsertRequest implements FieldContainer {
	 ...
	 * @return Fluent API
	 */
	public NodeUpsertRequest setSchema(SchemaReference schema) {
		this.schema = schema;
		return this;
	}
	 ...
	 * @return Fluent API
	 */
	public NodeUpsertRequest setParentNode(NodeReference parentNode) {
	 ...
	 * @return Fluent API
	 */
	public NodeUpsertRequest setParentNodeUuid(String uuid) {
	 ...
	 * @return Fluent API
	 */
	public NodeUpsertRequest setLanguage(String language) {
	 ...
	 * @return Fluent API
	 */
	public NodeUpsertRequest setFields(FieldMap fields) {
		this.fields = fields;
		return this;
	}
	 ...
	 * @return
	 */
	public NodeUpsertRequest setSchemaName(String schemaName) {
	 ...
	 * @return Fluent API
	 */
	public NodeUpsertRequest setTags(List<TagReference> tags) {
		this.tags = tags;
		return this;
	}
