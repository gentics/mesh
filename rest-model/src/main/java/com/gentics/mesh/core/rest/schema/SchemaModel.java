 ...
 */
public interface SchemaModel extends FieldSchemaContainer {
	 ...
	 *            Display field
	 */
	SchemaModel setDisplayField(String displayField);
	 ...
	 */
	SchemaModel setContainer(Boolean flag);
	 ...
	 * @return Fluent API
	 */
	SchemaModel setUrlFields(List<String> urlFields);
	 ...
	 * @return Fluent API
	 */
	default SchemaModel setUrlFields(String... fieldNames) {
