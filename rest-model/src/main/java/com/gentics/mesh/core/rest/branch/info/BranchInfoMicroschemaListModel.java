 ...
 */
public class BranchInfoMicroschemaListModel implements RestModel {
	 ...
	 */
	public BranchInfoMicroschemaListModel() {
	}

	public BranchInfoMicroschemaListModel(List<BranchMicroschemaInfo> microschemas) {
	 ...
	 * @return Fluent API
	 */
	public BranchInfoMicroschemaListModel add(MicroschemaReference... references) {
