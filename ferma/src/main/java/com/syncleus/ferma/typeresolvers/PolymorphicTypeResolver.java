...
public class PolymorphicTypeResolver implements TypeResolver {
	...
	/**
	 * Creates a new SimpleTypeResolver with a typing engine that can recognize the specified types. While these types still need to be included in a separate
	 * TypedModule they must be created here as well to ensure proper look-ups occur.
	 *
	 * @since 2.0.0
	 */
	 ...
	 *            the ReflectionCache used to examine the type hierarchy and do general reflection.
	 * @since 2.0.0
	 */
