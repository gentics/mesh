...
abstract class AbstractEdgeTraversal<C, S, M> extends AbstractTraversal<EdgeFrame, C, S, M> implements EdgeTraversal<C, S, M> {
	...
	@Override
	public <N> Traversal<EdgeFrame, Collection<? extends N>, N, M> store(final Collection<? super N> storage,
		final TraversalFunction<EdgeFrame, N> storageFunction) {
	...
	@Override
	public <K, V, V2> EdgeTraversal<Map<K, V2>, Map<K, V2>, M> groupBy(final TraversalFunction<EdgeFrame, K> keyFunction,
	...
	@Override
	public <K, V> EdgeTraversal<Map<K, List<V>>, Map<K, List<V>>, M> groupBy(final TraversalFunction<EdgeFrame, K> keyFunction,
		final TraversalFunction<EdgeFrame, Iterator<V>> valueFunction) {
	...
	@Override
	public <K, V> EdgeTraversal<Map<K, List<V>>, Map<K, List<V>>, M> groupBy(final Map<K, List<V>> map,
		final TraversalFunction<EdgeFrame, K> keyFunction,
		final TraversalFunction<EdgeFrame, Iterator<V>> valueFunction) {
	...
	@Override
	public EdgeTraversal<Collection<? extends EdgeFrame>, Collection<? extends EdgeFrame>, M> aggregate(
		final Collection<? super EdgeFrame> aggregate) {
		return (EdgeTraversal<Collection<? extends EdgeFrame>, Collection<? extends EdgeFrame>, M>) super.aggregate(aggregate);

	}

	@Override
	public <N> EdgeTraversal<Collection<? extends N>, Collection<? extends N>, M> aggregate(final Collection<? super N> aggregate,
		final TraversalFunction<EdgeFrame, ? extends N> aggregateFunction) {
	...
	@Override
	public <N> EdgeTraversal<Collection<? extends N>, Collection<? extends N>, M> aggregate(
		final TraversalFunction<EdgeFrame, ? extends N> aggregateFunction) {
